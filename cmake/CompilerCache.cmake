...
if(SCCACHE_BIN)
    message(STATUS "⚡ AROS-NG: Using sccache compiler launcher -> ${SCCACHE_BIN}")
...
elseif(CCACHE_BIN)
    message(STATUS "⚡ AROS-NG: Using ccache compiler launcher -> ${CCACHE_BIN}")
    ...
    message(STATUS "ℹ️ AROS-NG: Neither sccache nor ccache found; using standard compiler")
endif()
